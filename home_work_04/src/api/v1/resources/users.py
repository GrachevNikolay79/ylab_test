...
def user_list(user_service: UserService = Depends(get_user_service)) -> UserListResponse:
...
def user_detail(user_id: int, user_service: UserService = Depends(get_user_service)) -> UserModel:
...
def user_create(user: UserCreate, user_service: UserService = Depends(get_user_service)) -> UserModel:
